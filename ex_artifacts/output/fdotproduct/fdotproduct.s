	...
	.file	"TVMMod"
	.globl	__tvm_ffi_fdotproduct
	.p2align	2
	.type	__tvm_ffi_fdotproduct,@function
__tvm_ffi_fdotproduct:
.Lfunc_begin0:
...
.Ltmp244:
.Lfunc_end0:
	.size	__tvm_ffi_fdotproduct, .Lfunc_end0-__tvm_ffi_fdotproduct
	.cfi_endproc
...
.Lfunc_end2:
	...
	.p2align	2
	.type	fdotproduct_compute_,@function
fdotproduct_compute_:
.Lfunc_begin3:
	.loc	1 0 0
	.cfi_startproc
	addi	sp, sp, -16
...
.Ltmp251:
.Lfunc_end3:
	.size	fdotproduct_compute_, .Lfunc_end3-fdotproduct_compute_
	.cfi_endproc
...
.L.str.4:
	...
	.type	.L.str.5,@object
.L.str.5:
	.asciz	"fdotproduct(a: Tensor([64], float32), b: Tensor([64], float32), c: Tensor([1], float32))"
	.size	.L.str.5, 89
...
.Linfo_string2:
	.asciz	"."
.Linfo_string3:
	.asciz	"__tvm_ffi_fdotproduct"
.Linfo_string4:
	.asciz	"int32"
.Linfo_string5:
	.asciz	"fdotproduct_compute_"
.Linfo_string6:
	.asciz	"args"
.Linfo_string7:
	.asciz	"num_args"
...
.Linfo_string13:
	.asciz	"c_handle"
.Linfo_string14:
	.asciz	"fdotproduct.a_handle_shape"
.Linfo_string15:
	.asciz	"fdotproduct.a_handle_strides"
.Linfo_string16:
	.asciz	"a"
.Linfo_string17:
	.asciz	"float32"
.Linfo_string18:
	.asciz	"fdotproduct.b_handle_shape"
.Linfo_string19:
	.asciz	"fdotproduct.b_handle_strides"
.Linfo_string20:
	.asciz	"b"
.Linfo_string21:
	.asciz	"fdotproduct.c_handle_shape"
.Linfo_string22:
	.asciz	"c"
.Linfo_string23:
	.asciz	"self_handle"
