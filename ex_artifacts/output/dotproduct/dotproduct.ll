...
@.str.5 = private constant [88 x i8] c"dotproduct(a: Tensor([64], float32), b: Tensor([64], float32), c: Tensor([1], float32))\00", align 1
...
define dllexport noundef i32 @__tvm_ffi_dotproduct(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end14:                                     ; preds = %assert_end12
  ...
  %dotproduct.a_handle_shape = load ptr, ptr %29, align 8, !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.a_handle_shape, metadata !24, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.a_handle_shape, metadata !24, metadata !DIExpression()), !dbg !15
  %30 = getelementptr inbounds %1, ptr %a_handle, i64 0, i32 5, !dbg !15
  %dotproduct.a_handle_strides = load ptr, ptr %30, align 8, !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.a_handle_strides, metadata !25, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.a_handle_strides, metadata !25, metadata !DIExpression()), !dbg !15
...
assert_end22:                                     ; preds = %assert_end20
  ...
  %dotproduct.b_handle_shape = load ptr, ptr %49, align 8, !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.b_handle_shape, metadata !30, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.b_handle_shape, metadata !30, metadata !DIExpression()), !dbg !15
  %50 = getelementptr inbounds %1, ptr %b_handle, i64 0, i32 5, !dbg !15
  %dotproduct.b_handle_strides = load ptr, ptr %50, align 8, !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.b_handle_strides, metadata !31, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.b_handle_strides, metadata !31, metadata !DIExpression()), !dbg !15
...
assert_end30:                                     ; preds = %assert_end28
  ...
  %dotproduct.c_handle_shape = load ptr, ptr %68, align 8, !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.c_handle_shape, metadata !33, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.declare(metadata ptr %dotproduct.c_handle_shape, metadata !33, metadata !DIExpression()), !dbg !15
...
assert_end32:                                     ; preds = %assert_end30
  ...
  %.not70 = icmp eq ptr %dotproduct.a_handle_strides, null, !dbg !15
  br i1 %.not70, label %if_end, label %if_then, !dbg !15, !prof !17

if_then:                                          ; preds = %assert_end32
  %72 = load i64, ptr %dotproduct.a_handle_strides, align 8, !dbg !15
...
assert_end36:                                     ; preds = %if_end
  %.not72 = icmp eq ptr %dotproduct.b_handle_strides, null, !dbg !15
  br i1 %.not72, label %if_end38, label %if_then37, !dbg !15, !prof !17

if_then37:                                        ; preds = %assert_end36
  %75 = load i64, ptr %dotproduct.b_handle_strides, align 8, !dbg !15
...
assert_end52:                                     ; preds = %assert_end50
  %84 = load i64, ptr %dotproduct.a_handle_shape, align 8, !dbg !15
...
assert_end56:                                     ; preds = %assert_end54
  %90 = load i64, ptr %dotproduct.b_handle_shape, align 8, !dbg !15
...
assert_end60:                                     ; preds = %assert_end58
  %96 = load i64, ptr %dotproduct.c_handle_shape, align 8, !dbg !15
...
assert_end64:                                     ; preds = %assert_end62
  tail call fastcc void @dotproduct_compute_(ptr nonnull %a, ptr nonnull %b, ptr nonnull %c), !dbg !15
  br label %common.ret
}
...
define internal fastcc void @dotproduct_compute_(ptr noalias nocapture readonly align 64 %a, ptr noalias nocapture readonly align 64 %b, ptr noalias nocapture writeonly align 64 %c) unnamed_addr #4 !dbg !36 {
for_body_i.peel.next:
  tail call void @llvm.dbg.value(metadata ptr %a, metadata !40, metadata !DIExpression()), !dbg !43
  tail call void @llvm.dbg.value(metadata ptr %b, metadata !41, metadata !DIExpression()), !dbg !43
  tail call void @llvm.dbg.value(metadata ptr %c, metadata !42, metadata !DIExpression()), !dbg !43
  call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !43
  %0 = load float, ptr %a, align 64, !dbg !43, !tbaa !45
  %1 = load float, ptr %b, align 64, !dbg !43, !tbaa !48
  %2 = tail call float @llvm.fmuladd.f32(float %0, float %1, float 0.000000e+00), !dbg !43
  %3 = tail call i64 @llvm.vscale.i64(), !dbg !43
  %4 = and i64 %3, 4611686018427387888, !dbg !43
  %min.iters.check.not = icmp eq i64 %4, 0, !dbg !43
  br i1 %min.iters.check.not, label %vector.ph, label %for_body_i.preheader, !dbg !43, !prof !50

vector.ph:                                        ; preds = %for_body_i.peel.next
  %5 = tail call i64 @llvm.vscale.i64(), !dbg !43
  %6 = shl i64 %5, 2, !dbg !43
  %n.mod.vf = urem i64 63, %6, !dbg !43
  %ind.end = sub nuw nsw i64 64, %n.mod.vf, !dbg !43
  %7 = tail call i64 @llvm.vscale.i64(), !dbg !43
  %8 = shl i64 %7, 2, !dbg !43
  br label %vector.body, !dbg !43

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vec.phi = phi float [ %2, %vector.ph ], [ %12, %vector.body ]
  %offset.idx = or disjoint i64 %index, 1, !dbg !43
  %9 = getelementptr inbounds float, ptr %a, i64 %offset.idx, !dbg !43
  %wide.load = load <vscale x 4 x float>, ptr %9, align 4, !dbg !43, !tbaa !45
  %10 = getelementptr inbounds float, ptr %b, i64 %offset.idx, !dbg !43
  %wide.load1 = load <vscale x 4 x float>, ptr %10, align 4, !dbg !43, !tbaa !48
  %11 = fmul <vscale x 4 x float> %wide.load, %wide.load1
  %12 = tail call float @llvm.vector.reduce.fadd.nxv4f32(float %vec.phi, <vscale x 4 x float> %11)
  %index.next = add nuw i64 %index, %8
  %13 = xor i64 %n.mod.vf, %index.next
  %14 = icmp eq i64 %13, 63
  br i1 %14, label %for_body_i.preheader, label %vector.body, !prof !51, !llvm.loop !52

for_body_i.preheader:                             ; preds = %vector.body, %for_body_i.peel.next
  %indvars.iv.ph = phi i64 [ 1, %for_body_i.peel.next ], [ %ind.end, %vector.body ]
  %.ph = phi float [ %2, %for_body_i.peel.next ], [ %12, %vector.body ]
  br label %for_body_i, !dbg !43
...
for_body_i:                                       ; preds = %for_body_i.preheader, %for_body_i
  ...
  %15 = phi float [ %20, %for_body_i ], [ %.ph, %for_body_i.preheader ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv, metadata !44, metadata !DIExpression()), !dbg !43
  %16 = getelementptr inbounds float, ptr %a, i64 %indvars.iv, !dbg !43
  %17 = load float, ptr %16, align 4, !dbg !43, !tbaa !45
  %18 = getelementptr inbounds float, ptr %b, i64 %indvars.iv, !dbg !43
  %19 = load float, ptr %18, align 4, !dbg !43, !tbaa !48
  %20 = tail call float @llvm.fmuladd.f32(float %17, float %19, float %15), !dbg !43
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !43
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next, metadata !44, metadata !DIExpression()), !dbg !43
  %exitcond.not = icmp eq i64 %indvars.iv.next, 64, !dbg !43
  br i1 %exitcond.not, label %for_end_i, label %for_body_i, !dbg !43, !prof !56, !llvm.loop !57

for_end_i:                                        ; preds = %for_body_i
  store float %20, ptr %c, align 64, !dbg !43, !tbaa !58
  ret void, !dbg !43
}
...
entry:
  %4 = tail call i32 @__tvm_ffi_dotproduct(ptr poison, ptr %1, i32 %2, ptr poison), !dbg !15, !range !69
  ret i32 %4, !dbg !15
}
...
attributes #4 = { nofree noinline norecurse nosync nounwind memory(argmem: readwrite) "target-cpu"="generic" "target-features"="+v,+m,+f,+d" }
...
!5 = distinct !DISubprogram(name: "__tvm_ffi_dotproduct", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!24 = !DILocalVariable(name: "dotproduct.a_handle_shape", scope: !5, file: !1, type: !9)
!25 = !DILocalVariable(name: "dotproduct.a_handle_strides", scope: !5, file: !1, type: !9)
...
!30 = !DILocalVariable(name: "dotproduct.b_handle_shape", scope: !5, file: !1, type: !9)
!31 = !DILocalVariable(name: "dotproduct.b_handle_strides", scope: !5, file: !1, type: !9)
!32 = !DILocalVariable(name: "b", scope: !5, file: !1, type: !28)
!33 = !DILocalVariable(name: "dotproduct.c_handle_shape", scope: !5, file: !1, type: !9)
!34 = !DILocalVariable(name: "dotproduct.c_handle_strides", scope: !5, file: !1, type: !9)
!35 = !DILocalVariable(name: "c", scope: !5, file: !1, type: !28)
!36 = distinct !DISubprogram(name: "dotproduct_compute_", scope: !1, file: !1, type: !37, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !39)
!37 = !DISubroutineType(cc: DW_CC_nocall, types: !38)
!38 = !{!8, !28, !28, !28}
!39 = !{!40, !41, !42}
!40 = !DILocalVariable(name: "a", arg: 1, scope: !36, file: !1, type: !28)
!41 = !DILocalVariable(name: "b", arg: 2, scope: !36, file: !1, type: !28)
!42 = !DILocalVariable(name: "c", arg: 3, scope: !36, file: !1, type: !28)
!43 = !DILocation(line: 0, scope: !36)
!44 = !DILocalVariable(name: "i", scope: !36, file: !1, type: !8)
!45 = !{!46, !46, i64 0}
!46 = !{!"0x247e5070", !47, i64 0}
!47 = !{!"tvm-tbaa"}
!48 = !{!49, !49, i64 0}
!49 = !{!"0x249d0cb0", !47, i64 0}
!50 = !{!"branch_weights", i32 127, i32 1}
!51 = !{!"branch_weights", i32 1, i32 262142}
...
!57 = distinct !{!57, !53, !55, !54}
!58 = !{!59, !59, i64 0}
!59 = !{!"0x249a7b70.w4.b0", !60, i64 0}
!60 = !{!"0x249a7b70.w8.b0", !61, i64 0}
!61 = !{!"0x249a7b70.w16.b0", !62, i64 0}
!62 = !{!"0x249a7b70.w32.b0", !63, i64 0}
!63 = !{!"0x249a7b70.w64.b0", !64, i64 0}
!64 = !{!"0x249a7b70.w128.b0", !65, i64 0}
!65 = !{!"0x249a7b70.w256.b0", !66, i64 0}
!66 = !{!"0x249a7b70.w512.b0", !67, i64 0}
!67 = !{!"0x249a7b70.w1024.b0", !68, i64 0}
!68 = !{!"0x249a7b70", !47, i64 0}
!69 = !{i32 -1, i32 1}
